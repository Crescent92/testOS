...
typedef void (*open_type_t) (struct fs_node*, uint8, uint8);
...
typedef void (*create_type_t) (struct fs_node *, char * name, uint16 permission);
typedef void (*mkdir_type_t) (struct fs_node *, char * name, uint16 permission);
